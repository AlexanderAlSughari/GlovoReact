...
const ExploreMenu = ({category, setCategory}) => {
  return (
    <div className='flex flex-col gap-5 dark:bg-black' id='explore-menu'>
        ...
        <p className='max-w-[60%] columns-[#808080] laptop:max-w-full laptop:text-sm dark:text-[#ffffff]'>Wybieraj spośród różnorodnego menu obejmującego wyśmienitą gamę dań. Naszą misją jest zaspokojenie Twoich pragnień i podniesienie poziomu doznań kulinarnych, jeden pyszny posiłek na raz.</p>
